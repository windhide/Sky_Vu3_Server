...
public class ReprintService {
    ...
    public boolean insertReprint(Reprint reprint) {return reprintMapper.insertReprint(reprint);}

    public boolean updateReprint(Reprint reprint) {return reprintMapper.updateReprint(reprint);}
